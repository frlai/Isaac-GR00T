...
class Gr00tN1d7(PreTrainedModel):
    ...
    def get_action(
        self, inputs: dict,  options: dict[str, Any] | None = None, initial_noise: torch.Tensor | None = None
    ) -> BatchFeature:
        """
        ...
        backbone_outputs = self.backbone(backbone_inputs)
        action_outputs = self.action_head.get_action(backbone_outputs, action_inputs, options, initial_noise=initial_noise)

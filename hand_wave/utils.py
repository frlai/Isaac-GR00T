...
class UnitreeG1DataConfig_v3(BaseDataConfig):
    video_keys = ["video.rs_view"]
    state_keys = ["state.body", "state.hands"]
    action_keys = ["action.upper_body", "action.hands"]
    language_keys = ["annotation.human.task_description"]
...
class UnitreeG1DataConfig_v4(BaseDataConfig):
    video_keys = ["video.rs_view"]
    state_keys = ["state.body", "state.hands"]
    action_keys = ["action.upper_body", "action.hands"]
    language_keys = ["annotation.human.task_description"]
    ...
    def transform(self):
        transforms = [
            ...
            StateActionTransform(
                apply_to=self.action_keys,
                normalization_modes={key: "min_max" for key in self.action_keys},
                target_rotations={key: "axis_angle" for key in self.action_keys},
            ),
            # concat transforms
            ConcatTransform(
                video_concat_order=self.video_keys,
...
DATA_CONFIG_MAP["unitree_g1_v2"] = UnitreeG1DataConfig_v2()
DATA_CONFIG_MAP["unitree_g1_v3"] = UnitreeG1DataConfig_v3()
DATA_CONFIG_MAP["unitree_g1_v4"] = UnitreeG1DataConfig_v4()
